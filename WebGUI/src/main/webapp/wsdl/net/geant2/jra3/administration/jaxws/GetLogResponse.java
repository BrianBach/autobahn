...
@XmlRootElement(namespace = "http://administration.autobahn.geant.net/", name = "getLogResponse")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(namespace = "http://administration.autobahn.geant.net/", name = "getLogResponse")
