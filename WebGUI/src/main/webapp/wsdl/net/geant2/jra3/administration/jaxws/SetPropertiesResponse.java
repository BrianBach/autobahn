...
@XmlRootElement(namespace = "http://administration.autobahn.geant.net/", name = "setPropertiesResponse")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(namespace = "http://administration.autobahn.geant.net/", name = "setPropertiesResponse")
