...
@XmlRootElement(namespace = "http://useraccesspoint.autobahn.geant.net/", name = "cancelService")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(namespace = "http://useraccesspoint.autobahn.geant.net/", name = "cancelService")
