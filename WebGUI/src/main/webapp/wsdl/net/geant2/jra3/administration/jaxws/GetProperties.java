...
@XmlRootElement(namespace = "http://administration.autobahn.geant.net/", name = "getProperties")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(namespace = "http://administration.autobahn.geant.net/", name = "getProperties")
