...
@XmlRootElement(namespace = "http://administration.autobahn.geant.net/", name = "getServices")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(namespace = "http://administration.autobahn.geant.net/", name = "getServices")
