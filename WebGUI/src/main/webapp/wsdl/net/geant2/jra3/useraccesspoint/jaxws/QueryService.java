...
@XmlRootElement(namespace = "http://useraccesspoint.autobahn.geant.net/", name = "queryService")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(namespace = "http://useraccesspoint.autobahn.geant.net/", name = "queryService")
