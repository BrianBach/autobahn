...
@XmlRootElement(namespace = "http://useraccesspoint.jra3.geant2.net/", name = "queryService")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(namespace = "http://useraccesspoint.jra3.geant2.net/", name = "queryService")
