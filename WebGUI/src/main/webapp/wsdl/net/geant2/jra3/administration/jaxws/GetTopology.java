...
@XmlRootElement(namespace = "http://administration.autobahn.geant.net/", name = "getTopology")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(namespace = "http://administration.autobahn.geant.net/", name = "getTopology")
