...
@XmlRootElement(namespace = "http://useraccesspoint.jra3.geant2.net/", name = "cancelServiceResponse")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(namespace = "http://useraccesspoint.jra3.geant2.net/", name = "cancelServiceResponse")
