...
@XmlRootElement(namespace = "http://useraccesspoint.autobahn.geant.net/", name = "cancelServiceResponse")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(namespace = "http://useraccesspoint.autobahn.geant.net/", name = "cancelServiceResponse")
