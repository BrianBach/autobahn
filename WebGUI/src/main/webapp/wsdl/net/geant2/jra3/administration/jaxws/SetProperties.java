...
@XmlRootElement(namespace = "http://administration.autobahn.geant.net/", name = "setProperties")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(namespace = "http://administration.autobahn.geant.net/", name = "setProperties")
