...
@XmlRootElement(namespace = "http://administration.autobahn.geant.net/", name = "getReservation")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(namespace = "http://administration.autobahn.geant.net/", name = "getReservation")
