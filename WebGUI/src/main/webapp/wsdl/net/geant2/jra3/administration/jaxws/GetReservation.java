...
@XmlRootElement(namespace = "http://administration.jra3.geant2.net/", name = "getReservation")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(namespace = "http://administration.jra3.geant2.net/", name = "getReservation")
