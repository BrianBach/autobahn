 ...
 * generated in the net.geant2.jra3.gui package. 
...
public class ObjectFactory {
    ...
    private final static QName _Update_QNAME = new QName("http://gui.jra3.geant2.net/", "update");
    private final static QName _ReservationChangedResponse_QNAME = new QName("http://gui.jra3.geant2.net/", "reservationChangedResponse");
    private final static QName _UpdateResponse_QNAME = new QName("http://gui.jra3.geant2.net/", "updateResponse");
    private final static QName _StatusUpdated_QNAME = new QName("http://gui.jra3.geant2.net/", "statusUpdated");
    private final static QName _ReservationChanged_QNAME = new QName("http://gui.jra3.geant2.net/", "reservationChanged");
    private final static QName _StatusUpdatedResponse_QNAME = new QName("http://gui.jra3.geant2.net/", "statusUpdatedResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: net.geant2.jra3.gui
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://gui.jra3.geant2.net/", name = "update")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://gui.jra3.geant2.net/", name = "reservationChangedResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://gui.jra3.geant2.net/", name = "updateResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://gui.jra3.geant2.net/", name = "statusUpdated")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://gui.jra3.geant2.net/", name = "reservationChanged")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://gui.jra3.geant2.net/", name = "statusUpdatedResponse")
