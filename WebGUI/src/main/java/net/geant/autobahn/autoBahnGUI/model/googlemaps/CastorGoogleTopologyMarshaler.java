...
public class CastorGoogleTopologyMarshaler implements TopologyMarshaler {
	...
	/*
	 * (non-Javadoc)
	 * @see net.geant.autobahn.autoBahnGUI.model.googlemaps.TopologyMarshaler#topologyToString(net.geant.autobahn.autoBahnGUI.model.googlemaps.Topology)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see net.geant.autobahn.autoBahnGUI.model.googlemaps.TopologyMarshaler#topologyToDOMNode(org.w3c.dom.Node, net.geant.autobahn.autoBahnGUI.model.googlemaps.Topology)
	 */
