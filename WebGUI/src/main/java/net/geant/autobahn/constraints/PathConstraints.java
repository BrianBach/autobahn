...
import net.geant.autobahn.administration.ConstraintsNames;
 ...
 *       &lt;sequence>
 *         &lt;element name="addNames" type="{http://administration.autobahn.geant.net/}constraintsNames" maxOccurs="unbounded"/>
 *         &lt;element name="addConstraints" type="{constraints.autobahn.geant.net}AdditiveConstraint" maxOccurs="unbounded"/>
 *         &lt;element name="boolNames" type="{http://administration.autobahn.geant.net/}constraintsNames" maxOccurs="unbounded"/>
 *         &lt;element name="boolConstraints" type="{constraints.autobahn.geant.net}BooleanConstraint" maxOccurs="unbounded"/>
 *         &lt;element name="rangeNames" type="{http://administration.autobahn.geant.net/}constraintsNames" maxOccurs="unbounded"/>
 *         &lt;element name="rangeConstraints" type="{constraints.autobahn.geant.net}RangeConstraint" maxOccurs="unbounded"/>
 *         &lt;element name="minValNames" type="{http://administration.autobahn.geant.net/}constraintsNames" maxOccurs="unbounded"/>
 *         &lt;element name="minValConstraints" type="{constraints.autobahn.geant.net}MinValueConstraint" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
