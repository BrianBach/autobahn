 ...
 */
            ...
            /**
            *  InvalidFilterFaultType bean class
            */
        
        public  class InvalidFilterFaultType extends org.oasis_open.docs.wsrf.bf_2.BaseFaultType
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        /**
                        * field for UnknownFilter
                        * This was an Array!
                        */

                        
                                    protected javax.xml.namespace.QName[] localUnknownFilter ;
                           ...
                           */
                           public  javax.xml.namespace.QName[] getUnknownFilter(){
                              ...
                              /**
                               * validate the array for UnknownFilter
                               */
                              protected void validateUnknownFilter(javax.xml.namespace.QName[] param){
                              ...
                              * @param param UnknownFilter
                              */
                              public void setUnknownFilter(javax.xml.namespace.QName[] param){
                              
                                   validateUnknownFilter(param);

                               
                                      this.localUnknownFilter=param;
                              }
                             ...
                             */
                             public void addUnknownFilter(javax.xml.namespace.QName param){
                                   if (localUnknownFilter == null){
                                   localUnknownFilter = new javax.xml.namespace.QName[]{};
                                   }

                            

                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localUnknownFilter);
                               list.add(param);
                               this.localUnknownFilter =
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       InvalidFilterFaultType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":InvalidFilterFaultType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                             ...
                             if (localUnknownFilter!=null) {
                                   ...
                                   boolean emptyNamespace = namespace == null || namespace.length() == 0;
                                   prefix =  emptyNamespace ? null : xmlWriter.getPrefix(namespace);
                                   for (int i = 0;i < localUnknownFilter.length;i++){
                                        
                                            if (localUnknownFilter[i] != null){
                                        
                                                if (!emptyNamespace) {
                                                    if (prefix == null) {
                                                        java.lang.String prefix2 = generatePrefix(namespace);

                                                        xmlWriter.writeStartElement(prefix2,"UnknownFilter", namespace);
                                                        xmlWriter.writeNamespace(prefix2, namespace);
                                                        xmlWriter.setPrefix(prefix2, namespace);

                                                    } else {
                                                        xmlWriter.writeStartElement(namespace,"UnknownFilter");
                                                    }

                                                } else {
                                                    xmlWriter.writeStartElement("UnknownFilter");
                                                }

                                            
                                                        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localUnknownFilter[i]));
                                                    
                                                xmlWriter.writeEndElement();
                                              
                                                } else {
                                                   
                                                           throw new org.apache.axis2.databinding.ADBException("UnknownFilter cannot be null!!");
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://docs.oasis-open.org/wsn/b-2","InvalidFilterFaultType"));
                                  ...
                                  for (int i = 0;i < localUnknownFilter.length;i++){
                                         ...
                                         if (localUnknownFilter[i] != null){
                                          elementList.add(new javax.xml.namespace.QName("http://docs.oasis-open.org/wsn/b-2",
                                                                              "UnknownFilter"));
                                          elementList.add(
                                          org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localUnknownFilter[i]));
                                          } else {
    ...
    public static class Factory{
        ...
        */
        public static InvalidFilterFaultType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"InvalidFilterFaultType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (InvalidFilterFaultType)net.es.oscars.oscars.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list6 = new java.util.ArrayList();
                                   ...
                                   if (reader.isStartElement()){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://docs.oasis-open.org/wsn/b-2","UnknownFilter").equals(reader.getName())){
                                    ...
                                    list6.add(reader.getElementText());
                                            ...
                                            while(!loopDone6){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://docs.oasis-open.org/wsn/b-2","UnknownFilter").equals(reader.getName())){
                                                         list6.add(reader.getElementText());
                                            ...
                                            object.setUnknownFilter((javax.xml.namespace.QName[])
