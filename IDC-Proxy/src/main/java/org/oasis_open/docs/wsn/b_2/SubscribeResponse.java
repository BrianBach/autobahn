            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localTerminationTimeTracker = false ;
                            ...
                            /**
                               ...
                               */
                               public void setTerminationTime(java.util.Calendar param){
                                       ...
                                       if (param != null){
                                          //update the setting tracker
                                          localTerminationTimeTracker = true;
                                       } else {
                                          localTerminationTimeTracker = false;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       ...
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                             ...
                             } if (localTerminationTimeTracker){
                                    namespace = "http://docs.oasis-open.org/wsn/b-2";
                                    if (! namespace.equals("")) {
                                        prefix = xmlWriter.getPrefix(namespace);
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SubscribeResponse".equals(type)){
                                ...
                                return (SubscribeResponse)net.es.oscars.oscars.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
