 ...
 */
            ...
            /**
            *  CreatePullPointResponse bean class
            */
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected org.w3.www._2005._08.addressing.EndpointReferenceType localPullPoint ;
                           ...
                           */
                           public  org.w3.www._2005._08.addressing.EndpointReferenceType getPullPoint(){
                               return localPullPoint;
                           }
                            ...
                            /**
                               ...
                               * @param param PullPoint
                               */
                               public void setPullPoint(org.w3.www._2005._08.addressing.EndpointReferenceType param){
                            
                                            this.localPullPoint=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       CreatePullPointResponse.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":CreatePullPointResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "CreatePullPointResponse",
                           xmlWriter);
                                            ...
                                            if (localPullPoint==null){
                                                 throw new org.apache.axis2.databinding.ADBException("PullPoint cannot be null!!");
                                            }
                                           localPullPoint.serialize(new javax.xml.namespace.QName("http://docs.oasis-open.org/wsn/b-2","PullPoint"),
                                               factory,xmlWriter);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://docs.oasis-open.org/wsn/b-2",
                                    ...
                                    elementList.add(localPullPoint);
                                 if (localExtraElementTracker){
                            if (localExtraElement != null) {
                                for (int i = 0;i < localExtraElement.length;i++){
                                    if (localExtraElement[i] != null){
    ...
    public static class Factory{
        ...
        */
        public static CreatePullPointResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CreatePullPointResponse object =
                new CreatePullPointResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CreatePullPointResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CreatePullPointResponse)net.es.oscars.oscars.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://docs.oasis-open.org/wsn/b-2","PullPoint").equals(reader.getName())){
                                
                                                object.setPullPoint(org.w3.www._2005._08.addressing.EndpointReferenceType.Factory.parse(reader));
