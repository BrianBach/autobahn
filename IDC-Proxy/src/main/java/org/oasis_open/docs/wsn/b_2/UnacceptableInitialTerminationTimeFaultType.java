 ...
 */
            ...
            /**
            *  UnacceptableInitialTerminationTimeFaultType bean class
            */
        
        public  class UnacceptableInitialTerminationTimeFaultType extends org.oasis_open.docs.wsrf.bf_2.BaseFaultType
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected java.util.Calendar localMinimumTime ;
                           ...
                           */
                           public  java.util.Calendar getMinimumTime(){
                            ...
                            /**
                               ...
                               */
                               public void setMinimumTime(java.util.Calendar param){
                        ...
                        */
                                    ...
                                    protected java.util.Calendar localMaximumTime ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localMaximumTimeTracker = false ;
                           ...
                           */
                           public  java.util.Calendar getMaximumTime(){
                            ...
                            /**
                               ...
                               */
                               public void setMaximumTime(java.util.Calendar param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localMaximumTimeTracker = true;
                                       } else {
                                          localMaximumTimeTracker = false;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       UnacceptableInitialTerminationTimeFaultType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":UnacceptableInitialTerminationTimeFaultType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://docs.oasis-open.org/wsn/b-2","UnacceptableInitialTerminationTimeFaultType"));
                                  ...
                                  for (int i = 0;i < localDescription.length;i++){
                                    ...
                                    throw new org.apache.axis2.databinding.ADBException("Description cannot be null!!");
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://docs.oasis-open.org/wsn/b-2",
                                        ...
                                        if (localMinimumTime != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMinimumTime));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("MinimumTime cannot be null!!");
                                        }
                                     if (localMaximumTimeTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://docs.oasis-open.org/wsn/b-2",
                                        ...
                                        if (localMaximumTime != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMaximumTime));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("MaximumTime cannot be null!!");
                                        }
                                    }
    ...
    public static class Factory{
        ...
        */
        public static UnacceptableInitialTerminationTimeFaultType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"UnacceptableInitialTerminationTimeFaultType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (UnacceptableInitialTerminationTimeFaultType)net.es.oscars.oscars.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list4 = new java.util.ArrayList();
                                   ...
                                   if (reader.isStartElement()){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://docs.oasis-open.org/wsn/b-2","MinimumTime").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://docs.oasis-open.org/wsn/b-2","MaximumTime").equals(reader.getName())){
