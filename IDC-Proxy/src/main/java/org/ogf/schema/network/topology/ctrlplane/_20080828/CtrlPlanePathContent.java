        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected org.ogf.schema.network.topology.ctrlplane._20080828.CtrlPlaneHopContent[] localHop ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           /**
                           * Auto generated getter method
                           * @return org.ogf.schema.network.topology.ctrlplane._20080828.CtrlPlaneHopContent[]
                           */
                           public  org.ogf.schema.network.topology.ctrlplane._20080828.CtrlPlaneHopContent[] getHop(){
                               return localHop;
                           }
                               ...
                               */
                              protected void validateHop(org.ogf.schema.network.topology.ctrlplane._20080828.CtrlPlaneHopContent[] param){
                              ...
                              * @param param Hop
                              */
                              public void setHop(org.ogf.schema.network.topology.ctrlplane._20080828.CtrlPlaneHopContent[] param){
                             ...
                             * @param param org.ogf.schema.network.topology.ctrlplane._20080828.CtrlPlaneHopContent
                             */
                             public void addHop(org.ogf.schema.network.topology.ctrlplane._20080828.CtrlPlaneHopContent param){
                                   if (localHop == null){
                                   localHop = new org.ogf.schema.network.topology.ctrlplane._20080828.CtrlPlaneHopContent[]{};
                                   }
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localHop);
                               list.add(param);
                               this.localHop =
                             (org.ogf.schema.network.topology.ctrlplane._20080828.CtrlPlaneHopContent[])list.toArray(
                            new org.ogf.schema.network.topology.ctrlplane._20080828.CtrlPlaneHopContent[list.size()]);
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":CtrlPlanePathContent",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                                     ...
                                     if (localLifetimeTracker){
                                       ...
                                       if (localHop!=null){
                                            for (int i = 0;i < localHop.length;i++){
                                                if (localHop[i] != null){
                                                 localHop[i].serialize(new javax.xml.namespace.QName("http://ogf.org/schema/network/topology/ctrlPlane/20080828/","hop"),
                                                           factory,xmlWriter);
                                                } else {
                                               ...
                                               throw new org.apache.axis2.databinding.ADBException("hop cannot be null!!");
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CtrlPlanePathContent".equals(type)){
                                ...
                                return (CtrlPlanePathContent)net.es.oscars.oscars.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                   ...
                   if (tempAttribDirection!=null){
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ogf.org/schema/network/topology/ctrlPlane/20080828/","hop").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list2.add(org.ogf.schema.network.topology.ctrlplane._20080828.CtrlPlaneHopContent.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone2){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://ogf.org/schema/network/topology/ctrlPlane/20080828/","hop").equals(reader.getName())){
                                                                    list2.add(org.ogf.schema.network.topology.ctrlplane._20080828.CtrlPlaneHopContent.Factory.parse(reader));
                                                        ...
                                                        object.setHop((org.ogf.schema.network.topology.ctrlplane._20080828.CtrlPlaneHopContent[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                org.ogf.schema.network.topology.ctrlplane._20080828.CtrlPlaneHopContent.class,
                                                                list2));
