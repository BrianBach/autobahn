 ...
 * generated in the net.es.oscars.oscars package. 
...
public class ObjectFactory {
    ...
    private final static QName _InitiateTopologyPullResponse_QNAME = new QName("http://oscars.es.net/OSCARS", "initiateTopologyPullResponse");
    ...
    private final static QName _InitiateTopologyPull_QNAME = new QName("http://oscars.es.net/OSCARS", "initiateTopologyPull");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: net.es.oscars.oscars
     * 
     */
    ...
    /**
     * Create an instance of {@link InitiateTopologyPullContent }
     * 
     */
    public InitiateTopologyPullContent createInitiateTopologyPullContent() {
        return new InitiateTopologyPullContent();
    }
    ...
    /**
     * Create an instance of {@link InitiateTopologyPullResponseContent }
     * 
     */
    public InitiateTopologyPullResponseContent createInitiateTopologyPullResponseContent() {
        return new InitiateTopologyPullResponseContent();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link InitiateTopologyPullResponseContent }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://oscars.es.net/OSCARS", name = "initiateTopologyPullResponse")
    public JAXBElement<InitiateTopologyPullResponseContent> createInitiateTopologyPullResponse(InitiateTopologyPullResponseContent value) {
        return new JAXBElement<InitiateTopologyPullResponseContent>(_InitiateTopologyPullResponse_QNAME, InitiateTopologyPullResponseContent.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link InitiateTopologyPullContent }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://oscars.es.net/OSCARS", name = "initiateTopologyPull")
    public JAXBElement<InitiateTopologyPullContent> createInitiateTopologyPull(InitiateTopologyPullContent value) {
        return new JAXBElement<InitiateTopologyPullContent>(_InitiateTopologyPull_QNAME, InitiateTopologyPullContent.class, null, value);
    }
