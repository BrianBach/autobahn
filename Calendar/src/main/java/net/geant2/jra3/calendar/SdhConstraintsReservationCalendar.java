...
public class SdhConstraintsReservationCalendar implements
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.geant2.jra3.intradomain.calendar.ConstraintsReservationCalendar#checkConstraints(net.geant2.jra3.intradomain.pathfinder.IntradomainPath,
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.geant2.jra3.intradomain.calendar.ConstraintsReservationCalendar#releaseResources(java.util.List,
	 *      net.geant2.jra3.constraints.PathConstraints, java.util.Calendar,
	 *      java.util.Calendar)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.geant2.jra3.intradomain.calendar.ConstraintsReservationCalendar#reserveResources(java.util.List,
	 *      net.geant2.jra3.constraints.PathConstraints, java.util.Calendar,
	 *      java.util.Calendar)
	 */
