...
import net.geant2.jra3.converter.AccessPoint;
...
import net.geant2.jra3.utils.GN2_Jan08_DemoTopology;
...
public class ResourcesReservationTest extends TestCase {
	...
	protected void setUp() throws Exception {
        ...
        AccessPoint taAp = AccessPoint.getInstance();
        ...
        taAp.abstractExternalPartOfTopology_File("test_etc/external_ids.properties");
        ...
        TApoint = Endpoint.publish(props.getProperty("topologyabstraction.address"), 
                new net.geant2.jra3.converter.TopologyAbstractionImpl());
        ...
        Calpoint = Endpoint.publish(props.getProperty("resourcesreservationcalendar.address"), 
                new net.geant2.jra3.calendar.ResourcesReservationCalendarImpl());
