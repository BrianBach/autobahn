...
public abstract class GenericIntradomainPathfinder implements
	...
	/* (non-Javadoc)
	 * @see net.geant2.jra3.intradomain.pathfinder.IntradomainPathfinder#findPaths(net.geant2.jra3.intradomain.common.Node, net.geant2.jra3.intradomain.common.Node, java.util.Collection, int)
	 */
