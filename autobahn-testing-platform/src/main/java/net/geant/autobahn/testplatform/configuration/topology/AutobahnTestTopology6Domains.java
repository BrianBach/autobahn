...
public class AutobahnTestTopology6Domains {
    ...
    private final static Domain domain4 = new Domain("domain4", "localhost", 8083);
    private final static Domain domain5 = new Domain("domain5", "localhost", 8084);
    private final static Domain domain6 = new Domain("domain6", "localhost", 8085);
