...
import net.geant2.jra3.edugain.Edugain;
import net.geant2.jra3.edugain.SecurityTokenNotFoundException;
import net.geant2.jra3.edugain.WSSecurity;
import net.geant2.jra3.edugain.X509CertManager;
import net.geant2.jra3.edugain.EdugainCxfFault;
