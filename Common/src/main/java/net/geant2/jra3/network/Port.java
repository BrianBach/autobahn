...
@XmlType(name="Port", namespace="network.jra3.geant2.net", propOrder={
...
public class Port implements Serializable {
     ...
     * @param bodAddress
     *            String address used by JRA3 system
     * @param technology
    ...
    /**
     * The address that is used to access the port by JRA3 modules
     * 
    ...
    /**
     * Sets the address that is used to access the port by JRA3 modules
     * 
