 ...
 *
 */
public class AutobahnTestIntraTopologies2 {

    public static long _1Gb = (long) 1 * 1000 * 1000 * 1000;
    public static long _10Gb = (long) 10 * 1000 * 1000 * 1000;

    private final static String domain1 = "http://localhost:8080/autobahn-idm/services/interdomain";
    private final static String domain2 = "http://localhost:8081/autobahn-idm/services/interdomain";
    private final static String domain3 = "http://localhost:8082/autobahn-idm/services/interdomain";
	...
	public static void main(String[] args) {
    	...
    	try {
    		AutobahnTestIntraTopologies2 topo = new AutobahnTestIntraTopologies2();
	        ...
	        System.out.println("Przed comittem");
