...
import net.geant2.jra3.intradomain.common.dao.hibernate.HibernateGenericInterfaceDAO;
import net.geant2.jra3.intradomain.common.dao.hibernate.HibernateGenericLinkDAO;
import net.geant2.jra3.intradomain.common.dao.hibernate.HibernateNodeDAO;
import net.geant2.jra3.intradomain.dao.HibernateIntradomainReservationDAO;
...
import net.geant2.jra3.intradomain.ethernet.dao.hibernate.HibernateEthLinkDAO;
import net.geant2.jra3.intradomain.ethernet.dao.hibernate.HibernateEthPhysicalPortDAO;
import net.geant2.jra3.intradomain.ethernet.dao.hibernate.HibernateSpanningTreeDAO;
import net.geant2.jra3.intradomain.ethernet.dao.hibernate.HibernateVlanDAO;
import net.geant2.jra3.intradomain.ethernet.dao.hibernate.HibernateVlanPortDAO;
import net.geant2.jra3.intradomain.sdh.dao.SdhDeviceDAO;
import net.geant2.jra3.intradomain.sdh.dao.StmLinkDAO;
import net.geant2.jra3.intradomain.sdh.dao.hibernate.HibernateSdhDeviceDAO;
import net.geant2.jra3.intradomain.sdh.dao.hibernate.HibernateStmLinkDAO;
