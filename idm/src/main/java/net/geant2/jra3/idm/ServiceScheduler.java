...
import net.geant2.jra3.reservation.ServiceStatusListener;
...
final public class ServiceScheduler implements Runnable,  ServiceStatusListener {
	...
	/* (non-Javadoc)
	 * @see net.geant2.jra3.reservation.ServiceStatusListener#failed(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see net.geant2.jra3.reservation.ServiceStatusListener#scheduled(java.lang.String)
	 */
