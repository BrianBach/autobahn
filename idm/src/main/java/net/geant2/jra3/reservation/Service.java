...
import net.geant2.jra3.idm.ReservationProcessor;
import net.geant2.jra3.idm.ServiceScheduler;
...
@XmlType(name="Service", namespace="reservation.jra3.geant2.net", propOrder={
