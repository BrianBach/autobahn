 ...
 */
            ...
            /**
            *  UnsupportedPolicyRequestFaultType bean class
            */
        
        public  class UnsupportedPolicyRequestFaultType extends org.oasis_open.docs.wsrf.bf_2.BaseFaultType
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        /**
                        * field for UnsupportedPolicy
                        * This was an Array!
                        */

                        
                                    protected javax.xml.namespace.QName[] localUnsupportedPolicy ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localUnsupportedPolicyTracker = false ;
                           ...
                           */
                           public  javax.xml.namespace.QName[] getUnsupportedPolicy(){
                              ...
                              /**
                               * validate the array for UnsupportedPolicy
                               */
                              protected void validateUnsupportedPolicy(javax.xml.namespace.QName[] param){
                              ...
                              * @param param UnsupportedPolicy
                              */
                              public void setUnsupportedPolicy(javax.xml.namespace.QName[] param){
                              
                                   validateUnsupportedPolicy(param);

                               
                                          if (param != null){
                                             //update the setting tracker
                                             localUnsupportedPolicyTracker = true;
                                          } else {
                                             localUnsupportedPolicyTracker = false;
                                                 
                                          }
                                      
                                      this.localUnsupportedPolicy=param;
                              }
                             ...
                             */
                             public void addUnsupportedPolicy(javax.xml.namespace.QName param){
                                   if (localUnsupportedPolicy == null){
                                   localUnsupportedPolicy = new javax.xml.namespace.QName[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localUnsupportedPolicy);
                               list.add(param);
                               this.localUnsupportedPolicy =
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       UnsupportedPolicyRequestFaultType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":UnsupportedPolicyRequestFaultType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                             ...
                             if (localDescription!=null) {
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localUnsupportedPolicyTracker){
                             if (localUnsupportedPolicy!=null) {
                                   namespace = "http://docs.oasis-open.org/wsn/b-2";
                                   boolean emptyNamespace = namespace == null || namespace.length() == 0;
                                   prefix =  emptyNamespace ? null : xmlWriter.getPrefix(namespace);
                                   for (int i = 0;i < localUnsupportedPolicy.length;i++){
                                        
                                            if (localUnsupportedPolicy[i] != null){
                                        
                                                if (!emptyNamespace) {
                                                    if (prefix == null) {
                                                        java.lang.String prefix2 = generatePrefix(namespace);

                                                        xmlWriter.writeStartElement(prefix2,"UnsupportedPolicy", namespace);
                                                        xmlWriter.writeNamespace(prefix2, namespace);
                                                        xmlWriter.setPrefix(prefix2, namespace);

                                                    } else {
                                                        xmlWriter.writeStartElement(namespace,"UnsupportedPolicy");
                                                    }

                                                } else {
                                                    xmlWriter.writeStartElement("UnsupportedPolicy");
                                                }

                                            
                                                        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localUnsupportedPolicy[i]));
                                         ...
                                         throw new org.apache.axis2.databinding.ADBException("UnsupportedPolicy cannot be null!!");
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://docs.oasis-open.org/wsn/b-2","UnsupportedPolicyRequestFaultType"));
                                  ...
                                  for (int i = 0;i < localUnsupportedPolicy.length;i++){
                                         ...
                                         if (localUnsupportedPolicy[i] != null){
                                          elementList.add(new javax.xml.namespace.QName("http://docs.oasis-open.org/wsn/b-2",
                                                                              "UnsupportedPolicy"));
                                          elementList.add(
                                          org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localUnsupportedPolicy[i]));
                                          } else {
    ...
    public static class Factory{
        ...
        */
        public static UnsupportedPolicyRequestFaultType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            UnsupportedPolicyRequestFaultType object =
                new UnsupportedPolicyRequestFaultType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"UnsupportedPolicyRequestFaultType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (UnsupportedPolicyRequestFaultType)net.es.oscars.oscars.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list6 = new java.util.ArrayList();
                                   ...
                                   if (reader.isStartElement()){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://docs.oasis-open.org/wsn/b-2","UnsupportedPolicy").equals(reader.getName())){
                                    ...
                                    list6.add(reader.getElementText());
                                            ...
                                            while(!loopDone6){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://docs.oasis-open.org/wsn/b-2","UnsupportedPolicy").equals(reader.getName())){
                                                         list6.add(reader.getElementText());
                                            ...
                                            object.setUnsupportedPolicy((javax.xml.namespace.QName[])
