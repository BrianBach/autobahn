 ...
 */
            ...
            /**
            *  UnrecognizedPolicyRequestFaultType bean class
            */
        
        public  class UnrecognizedPolicyRequestFaultType extends org.oasis_open.docs.wsrf.bf_2.BaseFaultType
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        /**
                        * field for UnrecognizedPolicy
                        * This was an Array!
                        */

                        
                                    protected javax.xml.namespace.QName[] localUnrecognizedPolicy ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localUnrecognizedPolicyTracker = false ;
                           ...
                           */
                           public  javax.xml.namespace.QName[] getUnrecognizedPolicy(){
                               return localUnrecognizedPolicy;
                           }
                              ...
                              /**
                               * validate the array for UnrecognizedPolicy
                               */
                              protected void validateUnrecognizedPolicy(javax.xml.namespace.QName[] param){
                              ...
                              * @param param UnrecognizedPolicy
                              */
                              public void setUnrecognizedPolicy(javax.xml.namespace.QName[] param){
                              
                                   validateUnrecognizedPolicy(param);

                               
                                          if (param != null){
                                             //update the setting tracker
                                             localUnrecognizedPolicyTracker = true;
                                          } else {
                                             localUnrecognizedPolicyTracker = false;
                                                 
                                          }
                                      
                                      this.localUnrecognizedPolicy=param;
                              }
                             ...
                             */
                             public void addUnrecognizedPolicy(javax.xml.namespace.QName param){
                                   if (localUnrecognizedPolicy == null){
                                   localUnrecognizedPolicy = new javax.xml.namespace.QName[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localUnrecognizedPolicy);
                               list.add(param);
                               this.localUnrecognizedPolicy =
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       UnrecognizedPolicyRequestFaultType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":UnrecognizedPolicyRequestFaultType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                             ...
                             if (localDescription!=null) {
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localUnrecognizedPolicyTracker){
                             if (localUnrecognizedPolicy!=null) {
                                   namespace = "http://docs.oasis-open.org/wsn/b-2";
                                   boolean emptyNamespace = namespace == null || namespace.length() == 0;
                                   prefix =  emptyNamespace ? null : xmlWriter.getPrefix(namespace);
                                   for (int i = 0;i < localUnrecognizedPolicy.length;i++){
                                        
                                            if (localUnrecognizedPolicy[i] != null){
                                        
                                                if (!emptyNamespace) {
                                                    if (prefix == null) {
                                                        java.lang.String prefix2 = generatePrefix(namespace);

                                                        xmlWriter.writeStartElement(prefix2,"UnrecognizedPolicy", namespace);
                                                        xmlWriter.writeNamespace(prefix2, namespace);
                                                        xmlWriter.setPrefix(prefix2, namespace);

                                                    } else {
                                                        xmlWriter.writeStartElement(namespace,"UnrecognizedPolicy");
                                                    }

                                                } else {
                                                    xmlWriter.writeStartElement("UnrecognizedPolicy");
                                                }

                                            
                                                        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localUnrecognizedPolicy[i]));
                                         ...
                                         throw new org.apache.axis2.databinding.ADBException("UnrecognizedPolicy cannot be null!!");
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://docs.oasis-open.org/wsn/b-2","UnrecognizedPolicyRequestFaultType"));
                                  ...
                                  for (int i = 0;i < localUnrecognizedPolicy.length;i++){
                                         ...
                                         if (localUnrecognizedPolicy[i] != null){
                                          elementList.add(new javax.xml.namespace.QName("http://docs.oasis-open.org/wsn/b-2",
                                                                              "UnrecognizedPolicy"));
                                          elementList.add(
                                          org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localUnrecognizedPolicy[i]));
                                          } else {
    ...
    public static class Factory{
        ...
        */
        public static UnrecognizedPolicyRequestFaultType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"UnrecognizedPolicyRequestFaultType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (UnrecognizedPolicyRequestFaultType)net.es.oscars.oscars.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list6 = new java.util.ArrayList();
                                   ...
                                   if (reader.isStartElement()){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://docs.oasis-open.org/wsn/b-2","UnrecognizedPolicy").equals(reader.getName())){
                                    ...
                                    list6.add(reader.getElementText());
                                            ...
                                            while(!loopDone6){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://docs.oasis-open.org/wsn/b-2","UnrecognizedPolicy").equals(reader.getName())){
                                                         list6.add(reader.getElementText());
                                            ...
                                            object.setUnrecognizedPolicy((javax.xml.namespace.QName[])
                                                org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                            javax.xml.namespace.QName.class,list6));
