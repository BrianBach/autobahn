 ...
 */
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        /**
                        * field for MaximumNumber
                        */

                        
                                    protected org.apache.axis2.databinding.types.NonNegativeInteger localMaximumNumber ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localMaximumNumberTracker = false ;
                           ...
                           */
                           public  org.apache.axis2.databinding.types.NonNegativeInteger getMaximumNumber(){
                               return localMaximumNumber;
                           }
                            ...
                            /**
                               ...
                               */
                               public void setMaximumNumber(org.apache.axis2.databinding.types.NonNegativeInteger param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localMaximumNumberTracker = true;
                                       } else {
                                          localMaximumNumberTracker = false;
                                              
                                       }
                                   
                                            this.localMaximumNumber=param;
                ...
                if (localMaximumNumberTracker){
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"MaximumNumber", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"MaximumNumber");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("MaximumNumber");
                                    }
                                

                                          if (localMaximumNumber==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("MaximumNumber cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMaximumNumber));
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localMaximumNumberTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://docs.oasis-open.org/wsn/b-2",
                                        ...
                                        if (localMaximumNumber != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMaximumNumber));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("MaximumNumber cannot be null!!");
                                        }
                                    } if (localExtraElementTracker){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetMessages".equals(type)){
                                ...
                                return (GetMessages)net.es.oscars.oscars.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://docs.oasis-open.org/wsn/b-2","MaximumNumber").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setMaximumNumber(
