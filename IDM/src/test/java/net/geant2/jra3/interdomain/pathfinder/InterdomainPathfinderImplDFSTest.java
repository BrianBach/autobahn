 ...
 *
 */
public class InterdomainPathfinderImplDFSTest {
     ...
     * We exclude the lower middle port.
     */
    @Test
     ...
     * 
     * Tests IPF on a straight topology with multi-homed middle link.
     * We exclude the upper middle port.
     */
    @Test
     ...
     * 
     * Tests IPF on a straight topology with multi-homed middle link.
     * The reservation user excludes the upper middle port.
     */
    @Test
    public void testFindInterdomainPaths_multihomedmiddle_UserExclude1() {
        System.out.println("---------multihomedmiddle_UserExclude1");
        List<Link> ls = new ArrayList<Link>();
        ls.add(l1_2); ls.add(l2_2); ls.add(l2_3); ls.add(l2_3_2); ls.add(l3_3); ls.add(l3_4);
        // [n1_1]---[n2_1]---[n2_2]===[n3_1]---[n3_2]---[n4_1]
        topology_multihomed = new TopologyTest(ads, ls, ns);
     ...
     * 
     * Tests IPF on a straight topology with multi-homed middle link.
     * The reservation user excludes the lower middle port.
     */
    @Test
    public void testFindInterdomainPaths_multihomedmiddle_UserExclude2() {
        System.out.println("---------multihomedmiddle_UserExclude2");
        List<Link> ls = new ArrayList<Link>();
        ls.add(l1_2); ls.add(l2_2); ls.add(l2_3); ls.add(l2_3_2); ls.add(l3_3); ls.add(l3_4);
        // [n1_1]---[n2_1]---[n2_2]===[n3_1]---[n3_2]---[n4_1]
        topology_multihomed = new TopologyTest(ads, ls, ns);
     ...
     * 
     * Tests IPF on a straight topology with multi-homed middle link.
     * The reservation requests the upper middle port.
     */
    @Test
    public void testFindInterdomainPaths_multihomedmiddle_UserInclude1() {
        System.out.println("---------multihomedmiddle_UserInclude1");
        List<Link> ls = new ArrayList<Link>();
        ls.add(l1_2); ls.add(l2_2); ls.add(l2_3); ls.add(l2_3_2); ls.add(l3_3); ls.add(l3_4);
        // [n1_1]---[n2_1]---[n2_2]===[n3_1]---[n3_2]---[n4_1]
        topology_multihomed = new TopologyTest(ads, ls, ns);
     ...
     * 
     * Tests IPF on a straight topology with multi-homed middle link.
     * The reservation requests the lower middle port.
     */
    @Test
    public void testFindInterdomainPaths_multihomedmiddle_UserInclude2() {
        System.out.println("---------multihomedmiddle_UserInclude2");
        List<Link> ls = new ArrayList<Link>();
        ls.add(l1_2); ls.add(l2_2); ls.add(l2_3); ls.add(l2_3_2); ls.add(l3_3); ls.add(l3_4);
        // [n1_1]---[n2_1]---[n2_2]===[n3_1]---[n3_2]---[n4_1]
        topology_multihomed = new TopologyTest(ads, ls, ns);
