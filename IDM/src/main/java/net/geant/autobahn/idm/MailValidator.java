...
/**
 * An email address represents the textual string of an RFC 2822 email address
 * and other corresponding information of interest.
 * 
 * 
 * 
 * If you use this code, please keep the author information intact and reference
...
public class MailValidator {
     ...
     * address, e.g.:
     * 
     * someone@[192.168.1.100] or john.doe@[23:33:A2:22:16:1F] or me@[my
     * computer]
     * 
     ...
     * valid domain names (RFC 1035, x.y.z.com, etc), change this constant to
     * false.
     * 
     * Its default value is true to remain RFC 2822 compliant, but you should
     ...
     * (john.smith@somewhere.com - no quotes or angle brackets), then change
     * this constant to false.
     * 
     * Its default value is true to remain RFC 2822 compliant, but you should
     * set it depending on what you need for your application.
     */
