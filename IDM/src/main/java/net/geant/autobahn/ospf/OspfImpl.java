...
final public class OspfImpl implements Ospf {
    ...
    /* (non-Javadoc)
     * @see net.geant.autobahn.pathfinder.ospf.Ospf#connect(java.lang.String, int)
     */
    ...
    /* (non-Javadoc)
     * @see net.geant.autobahn.pathfinder.ospf.Ospf#disconnect()
     */
    ...
    /* (non-Javadoc)
     * @see net.geant.autobahn.pathfinder.ospf.Ospf#isConnected()
     */
    ...
    /* (non-Javadoc)
     * @see net.geant.autobahn.pathfinder.ospf.Ospf#registerOpaqueType(int, int)
     */
    ...
    /* (non-Javadoc)
     * @see net.geant.autobahn.pathfinder.ospf.Ospf#unregisterOpaqueType(int, int)
     */
    ...
    /* (non-Javadoc)
     * @see net.geant.autobahn.pathfinder.ospf.Ospf#registerEvents(int)
     */
    ...
    /* (non-Javadoc)
     * @see net.geant.autobahn.pathfinder.ospf.Ospf#synchronizeLsdb()
     */
    ...
    /* (non-Javadoc)
     * @see net.geant.autobahn.pathfinder.ospf.Ospf#originateLsa(java.lang.String, java.lang.String, int, int, int)
     */
    ...
    /* (non-Javadoc)
     * @see net.geant.autobahn.pathfinder.ospf.Ospf#originateLink(java.lang.String, java.lang.String, int, int, int, net.geant.autobahn.network.Link)
     */
    ...
    /* (non-Javadoc)
     * @see net.geant.autobahn.pathfinder.ospf.Ospf#deleteLsa(java.lang.String, int, int, int)
     */
    ...
    /* (non-Javadoc)
     * @see net.geant.autobahn.pathfinder.ospf.Ospf#addOspfAsync(net.geant.autobahn.pathfinder.ospf.OspfAsync)
     */
    ...
    /* (non-Javadoc)
     * @see net.geant.autobahn.pathfinder.ospf.Ospf#removeOspfAsync(net.geant.autobahn.pathfinder.ospf.OspfAsync)
     */
