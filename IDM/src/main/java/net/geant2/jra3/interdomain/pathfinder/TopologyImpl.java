...
import net.geant2.jra3.idm.TopologyMerge;
...
import net.geant2.jra3.ospf.Ospf;
import net.geant2.jra3.ospf.OspfAsync;
import net.geant2.jra3.ospf.OspfException;
import net.geant2.jra3.ospf.OspfImpl;
...
public final class TopologyImpl implements Topology, OspfAsync, Closeable {
	...
	/* (non-Javadoc)
     * @see net.geant2.jra3.pathfinder.interdomain.Quagga#getDomains()
     */
    ...
    /* (non-Javadoc)
     * @see net.geant2.jra3.pathfinder.interdomain.Quagga#getLinks()
     */
    ...
    /* (non-Javadoc)
     * @see net.geant2.jra3.pathfinder.interdomain.Quagga#getNodes()
     */
    ...
    /* (non-Javadoc)
     * @see net.geant2.jra3.pathfinder.interdomain.Topology#insertLink(net.geant2.jra3.pnetwork.Link)
     */
    ...
    /* (non-Javadoc)
     * @see net.geant2.jra3.pathfinder.interdomain.Topology#removeLink(net.geant2.jra3.pnetwork.Link)
     */
	...
	/* (non-Javadoc)
	 * @see net.geant2.jra3.ospf.OspfAsync#deleteNotify(java.lang.String, java.lang.String, int, net.geant2.jra3.ospf.lsa.OspfLsa)
	 */
	...
	/* (non-Javadoc)
	 * @see net.geant2.jra3.ospf.OspfAsync#delInterface(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see net.geant2.jra3.ospf.OspfAsync#ismChange(java.lang.String, java.lang.String, int)
	 */
	...
	/* (non-Javadoc)
	 * @see net.geant2.jra3.ospf.OspfAsync#newInterface(java.lang.String, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see net.geant2.jra3.ospf.OspfAsync#nsmChange(java.lang.String, java.lang.String, java.lang.String, int)
	 */
	...
	/* (non-Javadoc)
	 * @see net.geant2.jra3.ospf.OspfAsync#readyNotify(int, int, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see net.geant2.jra3.ospf.OspfAsync#updateNotify(java.lang.String, java.lang.String, int, net.geant2.jra3.ospf.lsa.OspfLsa)
	 */
